...
#  define AllocatingStorageWithDefaultNode  15 // Counted as a warning
...
#define RETURNERRINFO(COLOR,TYPE)                                                                                                                                              \
	...
	else if(TYPE == AllocatingStorageWithDefaultNode) {                                                                                                                    \
		printf("%sCannot allocate data from Default Database Node to User Created Node.\n\t_WARNING_STATUS_%d\n\n",COLOR,AllocatingStorageWithDefaultNode);            \
	}                                                                                                                                                                      \

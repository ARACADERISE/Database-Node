...
/* 
	Default Node File Names generated by SetupNode.py

	* There should only be four, error of more than 4 will be caught in SetupNode.py
*/
static const char * const DefNodeFileNames[] = {
	"DefaultDb1",
	"DefaultDb2",
	"DefaultDb3",
	"DefaultDb4"
